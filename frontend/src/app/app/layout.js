...
export default function RootLayout({ children }) {
  ...
  <path d="M110.8 87.514v-55.86a1.75 1.75 0 0 0-1.75-1.75h-90.1a1.75 1.75 0 0 0-1.75 1.75v55.86a1.75 1.75 0 0 0 1.75 1.75h90.1a1.75 1.75 0 0 0 1.75-1.75zm-3.5-1.75H20.7V33.4h86.6z"/>
